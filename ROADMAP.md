...
* \[x\] **Cost Function (Musical):** Implement tag-based filters (e.g., keeping only paths that contain 3rds or 6ths, or strict diatonic walks).
...
* \[x\] **Serialization:** Implement serde to read/write these profiles seamlessly.
